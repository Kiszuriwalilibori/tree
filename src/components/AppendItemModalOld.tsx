...
// tu zalozenia byłyby takie: inputValue idzie do formika a walidowane w formiku jest tylko na podstawie alfa jak przechodzi alfę to sukces j submit. Jak nie przejdzie to uwidacznia się element na podstawie submitCount i errors